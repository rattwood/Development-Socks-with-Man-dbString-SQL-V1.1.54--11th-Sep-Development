    ...
    Public Sub CreateNew()
        ...
        Select Case frmJobEntry.txtGrade.Text
            ...
            Case "P15 AS", "P20 BS"
                nfree = 13
                        'Product Name
                        MyPakExcel.Cells(8, 5) = frmDGV.DGVdata.Rows(0).Cells(52).Value       'E8
                        'Product Code
                        MyPakExcel.Cells(8, 14) = frmDGV.DGVdata.Rows(0).Cells(2).Value       'N8
                        'DATE
                        MyPakExcel.Cells(6, 4) = Date.Now.ToString("dd_MM_yyyy")              'D6
                        'CHEESE WEIGHT
                        MyPakExcel.Cells(13, 5) = frmJobEntry.varProdWeight                   'E13
                        'BARCODE IN
                        MyPakExcel.Cells(55, 16) = frmDGV.DGVdata.Rows(0).Cells(55).Value      'P55
            Case "ReCheck"
                nfree = 9
                        'Product Name
                ...
                ' MyPakExcel.Cells(53, 4) = frmDGV.DGVdata.Rows(0).Cells(55).Value      'D53
                createBarcode()
                MyPakExcel.Cells(1, 6) = SheetCodeString
