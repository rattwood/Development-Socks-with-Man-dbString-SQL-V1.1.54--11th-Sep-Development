...
Public Class frmSortReCheck
    Dim reSortExcel As New Excel.Application
    ...
    Private Sub frmColReCheck_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        btnNums = 1   'SET BUTTON NUMBERS 1-32
        btnNum = 1
        coneNumOffset = 0
        ...
        Me.lblJobNum.Text = frmJobEntry.txtLotNumber.Text   'SHOW CART BARCODE
        ...
        'Hide Cart Number text box and label
        ...
        Label9.Text = frmJobEntry.varProductName
    ...
    Private Sub btnCone1_Click(sender As Object, e As EventArgs) Handles btnCone1.Click
        ...
        Label4.Text = frmDGV.DGVdata.Rows((varConeNum - 1) - coneNumOffset).Cells(52).Value
        Label7.Text = frmDGV.DGVdata.Rows((varConeNum - 1) - coneNumOffset).Cells(36).Value
    ...
    Private Sub btnFinishedJob_Click(sender As Object, e As EventArgs) Handles btnFinishedJob.Click
        ...
        If txtKnitRef.Text = "" Or comKnitMC.Text = "" Or comStdMC.Text = "" Or txtStdDoff.Text = "" Or txtStdSpNum.Text = "" Then
            MsgBox("Please enter all Kniting & " & vbCrLf & "Standard Information and try Again")
            Exit Sub
        End If
    ...
    Private Sub printSheet()
        ...
        ReCheckworkbook = reSortExcel.Workbooks.Open(savename) '.Sheets(SheetNum)
        ...
        Try
            If File.Exists(savename) Then
                ...
                reSortExcel.Cells(1, 7) = (comKnitMC.Text & txtKnitRef.Text).ToString       'PUT KNITTING MACHINE AND REF NUMBER ON SHEET
                reSortExcel.Cells(47, 2) = ("Std M/C: " & comStdMC.Text & "  Doff: " & txtStdDoff.Text & "  S/P: " & txtStdSpNum.Text).ToString          'PUT STD CHEESE INFO ON SHEET
                reSortExcel.Cells(48, 2) = ("File Name: " & savename & ".xlsx").ToString     'PUT FILE NAME ON SHEET
        ...
        Try
            ...
            reSortExcel.DisplayAlerts = False
